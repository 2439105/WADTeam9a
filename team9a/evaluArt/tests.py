...
class templateTests(TestCase):
    ...
    def test_template_directory(self):
        ...
        about_str = get_template(template_path)
        artwork_list_str = get_template(template_path)
        base_str = get_template(template_path)
        contact_us_str = get_template(template_path)
        my_account_str = get_template(template_path)
        search_str = get_template(template_path)
        show_account_str = get_template(template_path)
        show_artworke_str = get_template(template_path)
        upload_artwork_str = get_template(template_path)
        
        self.assertTrue('action="{% url \'evaluArt:about\' %}"' in about_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:about'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:artwork_list\' %}"' in artwork_list_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:artwork_list'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:base\' %}"' in base_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:base'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:contact_us\' %}"' in contact_us_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:contact_us'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:my_account\' %}"' in my_account_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:my_account'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:search\' %}"' in search_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:search'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:show_account\' %}"' in show_account_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:show_account'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:show_artwork\' %}"' in show_artworke_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:show_artwork'.{FAILURE_FOOTER}")
        self.assertTrue('action="{% url \'evaluArt:upload_artwork\' %}"' in upload_artwork_str, f"{FAILURE_HEADER}Couldn't find the url lookup for 'evaluArt:upload_artwork'.{FAILURE_FOOTER}")